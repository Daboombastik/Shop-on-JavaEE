...
<div class="row">
	<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xlg-2">
		...
		<div id="product278009" class="panel panel-default product">
			<div class="panel-body">
				<div class="thumbnail">
					<img src="${pageContext.request.contextPath}static/media/736d61727470686f6e65.jpg" alt="Prestigio SH398187">
					<div class="desc">
						<div class="cell">
							<p>
	...
	<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xlg-2">
		...
		<div id="product278014" class="panel panel-default product">
			<div class="panel-body">
				<div class="thumbnail">
					<img src="${pageContext.request.contextPath}static/media/652d626f6f6b.jpg" alt="EvroMedia NU6353951">
					<div class="desc">
						<div class="cell">
							<p>
	...
	<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xlg-2">
		...
		<div id="product278018" class="panel panel-default product">
			<div class="panel-body">
				<div class="thumbnail">
					<img src="${pageContext.request.contextPath}static/media/736d61727470686f6e65.jpg" alt="Huawei BIC2404">
					<div class="desc">
						<div class="cell">
							<p>
	...
	<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xlg-2">
		...
		<div id="product278026" class="panel panel-default product">
			<div class="panel-body">
				<div class="thumbnail">
					<img src="${pageContext.request.contextPath}static/media/7461626c6574.jpg" alt="Apple QR35378150">
					<div class="desc">
						<div class="cell">
							<p>
	...
	<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xlg-2">
		...
		<div id="product278031" class="panel panel-default product">
			<div class="panel-body">
				<div class="thumbnail">
					<img src="${pageContext.request.contextPath}static/media/7461626c6574.jpg" alt="Acer JEQ0979832">
					<div class="desc">
						<div class="cell">
							<p>
	...
	<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xlg-2">
		...
		<div id="product278039" class="panel panel-default product">
			<div class="panel-body">
				<div class="thumbnail">
					<img src="${pageContext.request.contextPath}static/media/736d61727470686f6e65.jpg" alt="Samsung JL9994">
					<div class="desc">
						<div class="cell">
							<p>
