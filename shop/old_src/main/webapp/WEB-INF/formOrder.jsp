...
<%--        </fieldset>--%>
        <fieldset>
            ...
            <label for="dateCommande">Date <span class="required">*</span></label>
            <input type="text" id="dateCommande" name="dateCommande" value="" size="20" maxlength="20" required disabled />
            <br />

            <label for="montantCommande">Montant <span class="required">*</span></label>
            <input type="text" id="montantCommande" name="montantCommande" value="" size="20" maxlength="20" required/>
            <br />

            <label for="modePaiementCommande">Mode de paiement <span class="required">*</span></label>
            <input type="text" id="modePaiementCommande" name="modePaiementCommande" value="" size="20" maxlength="20" required/>
            <br />
            ...
            <label for="modeLivraisonCommande">Mode de livraison <span class="required">*</span></label>
            <input type="text" id="modeLivraisonCommande" name="modeLivraisonCommande" value="" size="20" maxlength="20" required />
            <br />
